 ...
 */
public class WardSpecification implements Specification<Ward> {

    /**
     *
     */
    private static final long serialVersionUID = -6319246890250681088L;
    private final SearchCriteria criteria;

    WardSpecification(SearchCriteria param) {
        this.criteria = param;
    }

    @Override
    public Predicate toPredicate(
            Root<Ward> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
